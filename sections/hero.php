    ...
    <div class="hero-body">
      ...
      <div class="container_r">
        <form name="reception-lp"
              class="form-track download-form"
              action=""
              method="post"
...
(function () {
  ...
  document.addEventListener('submit', function (e) {
    const form = e.target;
    if (!form.matches('form[name="reception-lp"]')) return;
    ...
    // contactUtil.js 経由で送信
    if (window.contactUtil && typeof window.contactUtil.sendRequest === 'function') {
      window.contactUtil.sendRequest({ formName: 'reception-lp', isNew: true });
    } else {
      console.error('contactUtil.sendRequest が見つかりません。/js/contactUtil.js の読み込みをご確認ください。');
    }
  }, true);
})();
</script>
